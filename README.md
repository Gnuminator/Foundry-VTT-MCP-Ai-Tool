...
<p align="center">
  <img src="docs/images/brand/demo.gif" alt="Foundry AI Tool — the co-GM dashboard in action: live combat tracker, the GM tool runner, confirm-gated actions, and the brand lockup" width="100%">
</p>

...
| 3   | Foundry module `data-access` / `queries` | upstream-derived | ⬜ Not started | Largest surface (`data-access.ts` ~11k LOC). Also still holds local PF2e/DSA5 remnants to remove. Inherits from chunk 2: Foundry-link frame-type adoption (`socket-bridge`/`webrtc-connection`, `import type` only per the bundler policy) and the transaction-manager rewrite.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
